...
SCENES.ap_eagle = {
  init(dom, canvas, ptr) {
    ...
    const lines=[
      {text:'Houston,',             size:fs,      weight:400, color:'rgba(255,255,255,.60)', at:0.3},
      {text:'Tranquility Base here.',size:fs*1.4,  weight:500, color:'rgba(255,255,255,.80)', at:1.2},
      {text:'The Eagle',             size:fs*1.9,  weight:700, color:'rgba(255,255,255,.90)', at:3.8},
      {text:'has landed.',           size:fs*2.8,  weight:900, color:'#fff',                  at:5.1},
    ];
...
SCENES.ap13 = {
  init(dom, canvas, ptr) {
    ...
    const lineDefs=[
      ...
      {text:'This is Houston. Say again, please.',    size:fs,      weight:400, color:'rgba(255,255,255,.55)', at:4.5},
      {text:'Ah, Houston,',                           size:fs,      weight:400, color:'rgba(255,255,255,.70)', at:9.0},
      {text:"we've had a problem.",                   size:fs*1.5,  weight:700, color:'#fff',                  at:10.2, accent:['problem']},
      {text:"We've had a Main B Bus Undervolt.",       size:fs*.9,   weight:300, color:'rgba(255,255,255,.55)', at:12.5},
    ];
...
SCENES.mer_orbit = {
  init(dom, canvas, ptr) {
    ...
    const lineDefs=[
      ...
      {text:'First, this...',                           size:fs,     weight:300, color:'rgba(255,255,255,.50)', at:5.2},
      {text:'certify you in orbit.',                    size:fs*1.9, weight:900, color:'#fff',                  at:7.0, accent:['orbit']},
    ];
